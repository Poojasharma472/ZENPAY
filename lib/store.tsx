...
interface StoreValue {
  ...
  updateVerification: (docType: "aadhaar" | "pan", document: AppState["verification"]["aadhaar"]) => void
  resetApp: () => void
}
...
function loadState(): AppState {
  ...
  try {
    ...
    ...createInitialState(),
    ...parsed,
    verification: { ...createInitialState().verification, ...parsed.verification },
  }
  } catch {
...
export function StoreProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<StoreValue>(() => {
    ...
    return {
      ...
      updateVerification: (docType, document) =>
        setState((s) => ({
          ...s,
          verification: { ...s.verification, [docType]: document },
        })),
      resetApp: () => {
